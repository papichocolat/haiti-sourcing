...
const LANG = {
  ...
  fr: {
    ...
    notice: 'Nous livrons actuellement à <strong>Port-au-Prince uniquement.</strong> Les commandes des États-Unis, du Canada ou de l'étranger sont livrées à votre famille à PAP.',
